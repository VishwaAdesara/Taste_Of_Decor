<?php
	...
	{
		$email = $_SESSION['sess_exp'];
		//$contact = $_SESSION['sess_admin'];
		
		$qry = "SELECT * FROM login_table, expert_table WHERE EMAIL_ID='$email'";
		$result = mysqli_query($con,$qry);
		$value = mysqli_fetch_array($result);
		$contact = $value['CONTACT_NO'];
		$name = $value['EXPERT_NAME'];
														...
														<!--/profile-inner-->
														 <div class="profile-section-inner">
														       <div class="col-md-6 profile-info">
																	...
																	<div class="main-grid3">
																     <div class="p-20">
																		<div class="about-info-p">
																			...
																			<br>
																			<p class="text-muted"><?php $query = "SELECT * FROM expert_table WHERE EXPERT_NAME='".$name."'";
																									$result = mysqli_query($con,$query);
																									while($value= mysqli_fetch_array($result))
																									{
																										echo $value['EXPERT_NAME'];
																									}?></p></p>
																		</div>
																		<div class="about-info-p">
																...
																<div class="submit"><a href="editpro.php"><input type="submit" name="edit" onclick="myFunction()" value="Edit Profile" ></a></div>
															  </div>
